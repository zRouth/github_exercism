...
class MatrixTest < MiniTest::Unit::TestCase
  ...
  def test_extract_a_row
    ...
    assert_equal [10, 20], matrix.rows[1]
  end
  ...
  #   long_string = (0..3000).to_a.map{ (0..3000).to_a.join(' ') }.join("\n")
  #   matrix = Matrix.new(long_string)
  #   assert_equal [100, 100, 100], matrix.columns[100][0..2]
  # end
end
